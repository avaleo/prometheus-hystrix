...
public class HystrixPrometheusMetricsPublisherCollapser implements HystrixMetricsPublisherCollapser {
    ...
    public void initialize() {
        ...
        addGauge("batch_size_mean", batchDoc, new Callable<Number>() {
            ...
            public Number call() throws Exception {
                return HystrixPrometheusMetricsPublisherCollapser.this.metrics.getBatchSizeMean();
            }
        });
        ...
        addGauge("shard_size_mean", shardDoc, new Callable<Number>() {
            @Override
            public Number call() throws Exception {
                return HystrixPrometheusMetricsPublisherCollapser.this.metrics.getShardSizeMean();
            }
        });
        ...
        if (exportProperties) {
            ...
            addGauge("property_value_max_requests_in_batch", doc,
                    new Callable<Number>() {
                        @Override
                        public Number call() throws Exception {
                            return HystrixPrometheusMetricsPublisherCollapser.this.properties.maxRequestsInBatch().get();
                        }
                    });
            ...
            addGauge("property_value_request_cache_enabled", doc,
                    new Callable<Number>() {
                        @Override
                        public Number call() throws Exception {
                            return HystrixPrometheusMetricsPublisherCollapser.this.properties.requestCacheEnabled().get() ? 1 : 0;
                        }
                    });
            ...
            addGauge("property_value_timer_delay_in_milliseconds", doc,
                    new Callable<Number>() {
                        @Override
                        public Number call() throws Exception {
                            return HystrixPrometheusMetricsPublisherCollapser.this.properties.timerDelayInMilliseconds().get();
                        }
                    });
            ...
            addGauge("property_value_rolling_statistical_window_in_milliseconds", doc,
                    new Callable<Number>() {
                        @Override
                        public Number call() throws Exception {
                            return HystrixPrometheusMetricsPublisherCollapser.this.properties.metricsRollingStatisticalWindowInMilliseconds().get();
                        }
                    });
        }
    }
    ...
    private void createCumulativeCountForEvent(String metric, final HystrixRollingNumberEvent event) {
        ...
        addGauge(metric, doc, new Callable<Number>() {
            @Override
            public Number call() throws Exception {
                return HystrixPrometheusMetricsPublisherCollapser.this.metrics.getCumulativeCount(event);
            }
        });
    }
    ...
    private void createRollingCountForEvent(String metric, final HystrixRollingNumberEvent event) {
        ...
        addGauge(metric, doc, new Callable<Number>() {
            @Override
            public Number call() throws Exception {
                return HystrixPrometheusMetricsPublisherCollapser.this.metrics.getRollingCount(event);
            }
        });
    }
    ...
    private void createBatchSizePercentile(String metric, final double percentile, String documentation) {
        addGauge(metric, documentation, new Callable<Number>() {
            @Override
            public Number call() throws Exception {
                return HystrixPrometheusMetricsPublisherCollapser.this.metrics.getBatchSizePercentile(percentile);
            }
        });
    }
    ...
    private void createShardSizePercentile(String metric, final double percentile, String documentation) {
        addGauge(metric, documentation, new Callable<Number>() {
            @Override
            public Number call() throws Exception {
                return HystrixPrometheusMetricsPublisherCollapser.this.metrics.getShardSizePercentile(percentile);
            }
        });
    }
